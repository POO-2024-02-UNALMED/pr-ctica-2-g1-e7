...
menu_archivo.add_command(label="Descripción del sistema", command=lambda: tk.messagebox.showinfo("Acerca de", "Autores: Equipo de Desarrollo JJAYC"))
menubar.add_cascade(label="Inicio", menu=menu_archivo)
